...
- ユーザーインターフェースの慣例 (おなじみのパターン) に従う。
- 予期しない変化をもたらすインタラクションを避ける。
- ユーザーの記憶に依存するインタラクションを避ける。
- コンテンツは明確かつなるべく平易な言葉で表現する。
- 見出しを提示してコンテンツの概要をつかみやすくする。
...
- ユーザー体験の観点からコンテンツの優先順位を明確にし、伝えたいことを上位に提示する。
- 文字サイズや行間を十分な大きさにして、可読性を高くする。
- ズーム (画面表示の拡大) を妨げない。
- 文字色と背景色のコントラストを十分に保つ。
